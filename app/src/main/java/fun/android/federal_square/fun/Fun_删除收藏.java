...
public class Fun_删除收藏 {
    public static void 启动(Activity activity, String time, View_Home_Collection view_我的_收藏){
    ...
    public static void 所有启动(View_Collectin activity, String time){
        AlertDialog dialog = new AlertDialog.Builder(activity).create();
        View view = View.inflate(activity, R.layout.window_delete_file, null);
        ImageView return_icon = view.findViewById(R.id.return_icon);
        AppCompatButton button_ok = view.findViewById(R.id.button_ok);
