...
#
# 软件介绍
 利用虚拟主机来搭建社区 可以引用他人的虚拟主机 进行互动交流 的开源项目<br />
 可以发布文字 图片 视频 动态图片<br />
 新增了翻页模式 可以在菜单设置文章数量为10 或者其他数量 然后下一页翻页浏览 文章再多也不怕<br />
 新增了 游客模式 陌生人获取到你的域名和密码 没有注册账号的话 那么只能在广场时间线查看十个文章 其他功能不可用<br />
 游客也无法查看 视频 图片 动图 等详细信息<br />
 网盘模式 专门的界面管理所有的图片视频文件 图片视频文件大小限制在5MB<br />
 可以在发布页面直接输入 图片 视频 的链接 直接导入 这样就不占用自己的服务器资源了<br />
 可以收藏别人的文章 可以转发别人的文章到自己的服务器 也就是JSON数据转发到自己的服务器<br />
 可以在文章下面进行简单的评论交流 目前不支持太丰富的功能<br />
 此项目与2024年12月17号开发完成 并且不断的修改BUG 由于还在发展期 如有BUG 请体谅<br />
#
#
# 优点
#
 数据在自己的手里 还可以引用别人的域名 所以说 并不是单机社区 而是 可以互动的社区
 极低的价格 虚拟空间价格非常低 低到70元一年 域名30元一年  稳定的功能 开发者业余时间很多 更新频繁
 由于APP模式 所以你的数据也不会被 搜索引擎获取到 这也是很好的特点
#
#
# 缺点
 由于虚拟主机的性能太小 所以不可以太花哨 虚拟主机的连接数量很少 每次只能有10个左右的连接数量 
 由于使用http 而不是 https 所以你的数据不会加密 但是个人使用也不会有人去特意去查你
 如果你需要加密的 那么你应该去寻找其他软件平台 或者你可以修改源代码 自己编译
#
#
